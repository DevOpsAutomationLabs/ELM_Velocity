...
<br/>
1. To access the Velocity plugin interface, log into Velocity (uid: admin / pwd: admin), and click on the <img src="media/setting_icon.png" alt="settings icon" style="width:5%; height:5%;"> icon (top RHS of the browser window).
