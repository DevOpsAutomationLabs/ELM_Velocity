...
| 9 | Click on one of the "DOTS" in the In Progress stage which has a red circle around it. A red cirlce indicates that a work item has been in a stage longer than the average time. | <img src="media/d1_9.png" alt="d1_9" style="width:30%; height:auto;"> |
